...
v = dat_aqua %>% subset(Gamma>0.6 & Gamma < .7) %>% select(actual_v) %>% pull()
...
plot +
  geom_segment(x = actual_steady[1], xend = actual_steady[1], y=0, yend=growth(actual_steady[1]))+
  geom_segment(x = actual_steady[2], xend = actual_steady[2], y=0, yend=growth(actual_steady[2]))+
  geom_segment(x = actual_steady[3], xend = actual_steady[3], y=0, yend=growth(actual_steady[3]))
