...
print(paste0('Monopoly scenario with cost parameter c=',c, ' is a ', round((dat_monop$x - dat_q_pt$x)/dat_q_pt$x*100,2), '% variation in stock in tonnes (compared to OA) or, equivalently, of ', round((dat_monop$x - dat_q_pt$x)*1000/25.7), ' adult totoabas'))
