...
# As before, we assume there are 38.91 individual totoaba in a tonne.

# Therefore, 

dat_p <- dat_p %>%
  mutate(individuals_shipment = q*38.91)

# Each average individual (assuming each individual has a 500 gram buche) is worth the price per  buche
